  ...
  if (source === "habr") {
    ...
    return data.items.map((item) => ({
      ...
      cover_image:
        ...
        "https://placehold.co/600x337/161b22/ff8c00?text=Habr",
    ...
    return data.map((article) => ({
      ...
      cover_image:
        article.cover_image ||
        "https://placehold.co/600x337/161b22/ff8c00?text=Dev.to",
...
const Explore = () => {
  ...
  const { data: articles, isLoading } = useQuery({
    queryKey: ["explore-articles", source],
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Box sx={{ mb: 6, textAlign: "center" }}>
        <Typography
          variant="h3"
          sx={{ fontWeight: 900, mb: 1, textTransform: "uppercase" }}
        >
        ...
        {isLoading ? (
          Array.from(new Array(6)).map((_, i) => (
            <Skeleton
              ...
              variant="rectangular"
              height={300}
              sx={{ bgcolor: "#161b22", borderRadius: 2 }}
            />
          ))
                  ...
                  >
                    ...
                    <Box className="card-footer">
                      ...
                      <IconButton
                        ...
                        sx={{ color: isBookmarked ? "#ff8c00" : "#8b949e" }}
                      >
                        <Bookmark
                          size={22}
                          fill={isBookmarked ? "#ff8c00" : "none"}
                        />
                      </IconButton>
                    </Box>
                  </CardContent>
